...
PASS src/messages/messages.service.spec.ts
  MessagesService
    create()
      v should save message to MongoDB
      v should publish event to Kafka after saving
      v should return saved message
    findAll()
      v should return paginated messages
      v should query correct conversationId
      v should calculate hasNextPage correctly
    search()
      v should call elasticsearch searchMessages
      v should return empty array for empty query
...
400
Bad Request
Missing required fields or validation failed
401
Unauthorized
